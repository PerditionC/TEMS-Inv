...
{
    /// <summary>
    /// See SearchFilterItems.ItemTypeMatching, who search criteria is applied, any of same type of item(s) or exactly specified item(s)
    /// </summary>
    ...
    /// </summary>
    public class SearchFilterItems : NotifyPropertyChanged //, ICloneable
    {
        /// <summary>
        ...
        public void InitializeAs(SearchFilterItems searchFilterItems)
        {
