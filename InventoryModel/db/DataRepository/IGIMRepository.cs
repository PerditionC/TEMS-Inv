...
namespace TEMS.InventoryModel.entity.db
{
    ...
    public interface IGEMRepository  //  GIM item lookups
    {
        ...
        /// <returns></returns>
        ObservableCollection<SearchResult> GetItemTree(QueryResultEntitySelector resultEntitySelector, SearchFilterOptions searchFilter, out GenericItemResult selectedItem);
