...
// based on https://joshsmithonwpf.wordpress.com/2009/07/11/one-way-to-avoid-messy-propertychanged-event-handling/
...
namespace TEMS_Inventory.UserControls
{
    ...
    sealed public class PropertyObserver<TPropertySource> : IWeakEventListener
        where TPropertySource : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <param name="propertyName">A lambda expression like 'n => n.PropertyName'.  
        /// Note: n.PropertyName.SubProperty will not trigger events -- use a new new PropertyObserver on n.Property and m.SubProperty
        /// </param>
        /// <returns>The object on which this method was invoked, to allow for multiple invocations chained together.</returns>
